...
internal class AnalyzerTest {
    ...
    fun should_ReturnNumberOfAppsDevelopedByACompany_When_CompanyNameEqualsToGoogle(){
        ...
        val result = analyzer.getPercentageOfCategory(apps,"google")
    ...
    fun should_ReturnNumberOfAppsDevelopedByACompany_When_CompanyNameContainsSpace(){
        ...
        val result = analyzer.getPercentageOfCategory(apps,"goo gle")
        //then check the result
    ...
    fun should_ReturnZero_When_CompanyNameNotFound(){
        ...
        val result = analyzer.getPercentageOfCategory(apps,"sfkjnc")
        //then check the result
        assertEquals(0, result)
    }
    ...
    fun should_Return_TopLargestApps() {
        ...
        val functionResultValue = analyzer.theLargestTopApps(apps,valueReturnNumber)
    ...
    fun should_ReturnNull_When_TheListIsEmpty() {
        ...
        val result = analyzer.topAppInstall(appDataList = apps, size = 10)
    ...
    fun should_ReturnTopAppInstall_WhenHasValidData() {
        ...
        val result = analyzer.topAppInstall(appDataList = apps, size = 2)
    ...
    fun should_ReturnNullWhenTheEnterNumberOfAppsIsZero() {
        ...
        apps = setList()
        //when search for top 3 app install
        val result = analyzer.topAppInstall(appDataList = apps, size = 0)
        //then should return Null
        assertNull(result)
    }
    ...
    fun should_ReturnNullWhenTheEnterNumberOfAppsIsLessThenZero() {
        ...
        apps = setList()
        //when search for top 3 app install
        val result = analyzer.topAppInstall(appDataList = apps, size =  -1)
        //then should return Null
        assertNull(result)
    }
